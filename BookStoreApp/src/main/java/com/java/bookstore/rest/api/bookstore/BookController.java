 ...
 */
@RestController
@RequestMapping(RestConstants.BOOK_ENDPOINT)
public class BookController {
	 ...
	 * @return
	 */
	@RequestMapping(value = RestConstants.ENDPOINT_SEPARATOR, method = RequestMethod.GET, produces = RestConstants.APPLICATION_PRODUCER_TYPE)
	 ...
	 * @return
	 */
	@RequestMapping(value = RestConstants.BY_ISBNID, method = RequestMethod.GET, produces = RestConstants.APPLICATION_PRODUCER_TYPE)
	 ...
	 * @return
	 */
	@RequestMapping(value = RestConstants.BY_ISBNID, method = RequestMethod.PUT, produces = RestConstants.APPLICATION_PRODUCER_TYPE)
	 ...
	 * @return
	 */
	@RequestMapping(value = RestConstants.BY_ISBNID, method = RequestMethod.DELETE, produces = RestConstants.APPLICATION_PRODUCER_TYPE)
